defmodule Slack.Files do
  ...
  def delete(file, options \\ %{}) do
    ...
    Slack.request("files.delete", params)
  end
  ...
  def info(file, options \\ %{}) do
    params = options |> Map.merge(%{file: file})
    Slack.request("files.info", params)
  end
  ...
  """
  def list(options \\ %{}) do
    Slack.request("files.list", options)
  end
  ...
  def upload(file, options \\ %{}) do
    params = options |> Map.merge(%{file: file})
    Slack.request("files.upload", params)
  end
end
