defmodule Slack.Files.Comments do
  @moduledoc """
  ...
  def add(file, comment, options \\ %{}) do
    ...
    Slack.request("files.comments.add", params)
  end
  ...
  def delete(file, id, options \\ %{}) do
    ...
    Slack.request("files.comments.delete", params)
  end
  ...
  def edit(file, id, comment, options \\ %{}) do
    ...
    Slack.request("files.comments.edit", params)
  end
end
