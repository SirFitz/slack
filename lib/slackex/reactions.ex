defmodule Slack.Reactions do
  ...
  def add(name, options \\ %{}) do
    ...
    Slack.request("reactions.add", params)
  end
  ...
  """
  def get(options \\ %{}) do
    Slack.request("reactions.get", options)
  end
  ...
  """
  def list(options \\ %{}) do
    Slack.request("reactions.list", options)
  end
  ...
  def remove(name, options \\ %{}) do
    params = options |> Map.merge(%{name: name})
    Slack.request("reactions.remove", params)
  end
end
