defmodule Slack.Groups do
  ...
  def archive(channel, options \\ %{}) do
    ...
    Slack.request("groups.archive", params)
  end
  ...
  def close(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("groups.close", params)
  end
  ...
  def create(name, options \\ %{}) do
    ...
    Slack.request("groups.create", params)
  end
  ...
  def create_child(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("groups.createChild", params)
  end
  ...
  def history(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("groups.history", params)
  end
  ...
  def info(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("groups.info", params)
  end
  ...
  def invite(channel, user, options \\ %{}) do
    ...
    Slack.request("groups.invite", params)
  end
  ...
  def kick(channel, user, options \\ %{}) do
    params = options |> Map.merge( %{channel: channel, user: user})
    Slack.request("groups.kick", params)
  end
  ...
  def leave(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("groups.leave", params)
  end
  ...
  """
  def list(options \\ %{}) do
    Slack.request("groups.list", options)
  end
  ...
  def mark(channel, timestamp, options \\ %{}) do
    ...
    Slack.request("groups.mark", params)
  end
  ...
  def open(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("groups.open", params)
  end
  ...
  def rename(channel, name, options \\ %{}) do
    ...
    Slack.request("groups.rename", params)
  end
  ...
  def set_purpose(channel, purpose, options \\ %{}) do
    ...
    Slack.request("groups.setPurpose", params)
  end
  ...
  def set_topic(channel, topic, options \\ %{}) do
    ...
    Slack.request("groups.setTopic", params)
  end
  ...
  def unarchive(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("groups.unarchive", params)
  end
end
