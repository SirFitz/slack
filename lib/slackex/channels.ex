defmodule Slack.Channels do
  ...
  def archive(channel, options \\ %{}) do
    ...
    Slack.request("channels.archive", params)
  end
  ...
  def create(name, options \\ %{}) do
    ...
    Slack.request("channels.create", params)
  end
  ...
  def history(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("channels.history", params)
  end
  ...
  def info(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("channels.info", params)
  end
  @doc """
  ...
  def invite(channel, user, options \\ %{}) do
    ...
    Slack.request("channels.invite", params)
  end
  ...
  def join(name, options \\ %{}) do
    params = options |> Map.merge(%{name: name})
    Slack.request("channels.join", params)
  end
  ...
  def kick(channel, user, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel, user: user})
    Slack.request("channels.kick", params)
  end
  ...
  def leave(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("channels.leave", params)
  end
  ...
  """
  def list(options \\ %{}) do
    Slack.request("channels.list", options)
  end
  ...
  def mark(channel, timestamp, options \\ %{}) do
    ...
    Slack.request("channels.mark", params)
  end
  ...
  def rename(channel, new_name, options \\ %{}) do
    ...
    Slack.request("channels.rename", params)
  end
  ...
  def set_purpose(channel, purpose, options \\ %{}) do
    ...
    Slack.request("channels.setPurpose", params)
  end
  ...
  def set_topic(channel, topic, options \\ %{}) do
    ...
    Slack.request("channels.setTopic", params)
  end
  ...
  def unarchive(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("channels.unarchive", params)
  end
end
