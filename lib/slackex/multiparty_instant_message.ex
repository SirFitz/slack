defmodule Slack.MPIM do
  ...
  def close(channel, options \\ %{}) do
    ...
    Slack.request("mpim.close", params)
  end
  ...
  def history(channel, options \\ %{}) do
    params = options |> Map.merge(%{channel: channel})
    Slack.request("mpim.history", params)
  end
  ...
  """
  def list(options \\ %{}) do
    Slack.request("mpim.list", options)
  end
  ...
  def mark(channel, timestamp, options \\ %{}) do
    ...
    Slack.request("mpim.mark", params)
  end
  ...
  def open(users, options \\ %{}) do
    ...
    Slack.request("mpim.open", params)
  end
end
